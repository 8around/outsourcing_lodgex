...
export const CONSULTING_STEPS = [
  {
    ...
    title: '운영 진단 신청',
    description:
      '호텔 현황과 개선 요구사항을 파악하여 맞춤형 진단 계획을 수립합니다.',
    icon: '📋',
  },
  {
    step: 2,
    title: '전문가 매칭',
    description: '호텔 규모와 특성에 맞는 전문 컨설턴트를 배정합니다.',
    icon: '👥',
  },
  {
    step: 3,
    title: '현장 분석 & 컨설팅 진행',
    description: '현장 방문을 통해 운영 실태를 분석하고 개선방안을 도출합니다.',
    icon: '🔍',
  },
  {
    step: 4,
...
export const SERVICE_CATEGORIES = {
  MANAGEMENT: {
    ...
    title: '호텔 위탁 운영',
    description:
      '전문성과 경험을 바탕으로 호텔 운영 전반을 체계적으로 관리합니다.',
    icon: '🏨',
    services: [
      {
        title: '객실 운영',
  ...
  CONSULTING: {
    ...
    title: '호텔 경영 컨설팅',
    description:
      '전략적 관점에서 호텔의 경쟁력을 강화하고 브랜드 가치를 제고합니다.',
    icon: '💼',
    services: [
      {
