...
export const testimonialsData: BoardPost[] = [
  {
    ...
    content: 'Lodgense의 컨설팅을 통해 20년된 호텔을 현대적이고 경쟁력 있는 호텔로 완전히 변모시켰습니다...',
  ...
  },
  {
    ...
    content: 'Lodgense의 운영 컨설팅을 통해 인력 효율성 25% 향상과 고객 서비스 품질 개선을 동시에 달성...',
  ...
  },
  {
    ...
    content: 'Lodgense의 수익관리 컨설팅을 통해 GOP 마진 12% 개선과 운영 효율성을 크게 향상시켰습니다...',
