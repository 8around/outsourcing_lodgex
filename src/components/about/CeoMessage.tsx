          ...
          <div className="prose prose-lg max-w-none">
            ...
            >
              <p className="text-lg font-medium text-primary-800 mb-8">
                Lodgense 호텔 운영 플랫폼은 숙박업·호텔 운영 전문성과 디지털 혁신을 바탕으로 변화하는 관광·레저 산업 환경 속에서 차별화된 솔루션을 제공하고자 합니다.
              </p>
              <p>
              ...
              <p>
                Lodgense는 축적된 호텔·리조트 운영 노하우와 성공 사례를 바탕으로 고객과 함께 성장하는 신뢰받는 파트너로 자리매김하고 있습니다.
              </p>
